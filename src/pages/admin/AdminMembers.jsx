...
const fetchRequests = async () => {
  try {
    ...
    // Then fetch user and group data separately
      ...
      <div style={{ maxWidth:600, margin:'0 auto', padding:'16px 20px 0' }}>
        ...
        {activeTab === 'members' && (
          <div style={{ display:'flex', flexDirection:'column', gap:10 }}>
            {filtered.length === 0 ? (
              <div style={{ textAlign:'center', padding:'40px 0', color:'#534AB7', fontSize:13 }}>
                No members found
              </div>
                ...
                <div style={{ display:'flex', gap:12, alignItems:'center' }}>
                  ...
                  <div style={{ flex:1, minWidth:0 }}>
                    ...
                    <div style={{ fontSize:11, color:'#534AB7', marginTop:1 }}>
                      📱 {member.phone} · {member.state}
                    </div>
                    <div style={{ fontSize:11, color:'#AFA9EC', marginTop:1 }}>
                      💼 {member.occupation} · {member.employment_status}
                    </div>
                  </div>
                  <div style={{ textAlign:'right', flexShrink:0 }}>
                    <div style={{ fontSize:11, color:'#534AB7' }}>
                      {member.slots?.length || 0} slot{member.slots?.length !== 1 ? 's' : ''}
                    </div>
                    <div style={{ fontSize:10, color:'#3C3489', marginTop:2 }}>
                      {dayjs(member.created_at).format('DD MMM YY')}
                    </div>
              ...
              >
                <div style={{ display:'flex', gap:12, alignItems:'flex-start', marginBottom:12 }}>
                  ...
                  <div style={{ flex:1 }}>
                    ...
                    <div style={{ fontSize:11, color:'#534AB7', marginTop:1 }}>
                      💼 {req.users?.occupation} · {req.users?.employment_status}
                    </div>
                    <div style={{ fontSize:11, color:'#534AB7' }}>
                      💰 {req.users?.income_range}
                    </div>
                  </div>
                  <div style={{ fontSize:10, color:'#3C3489' }}>
                    {dayjs(req.created_at).format('DD MMM')}
                  </div>
                </div>
                ...
                {/* Address */}
                <div style={{
                  fontSize:11, color:'#AFA9EC', marginBottom:12,
                  background:'#1f1d35', borderRadius:8, padding:'8px 10px',
                }}>
        ...
        {showProfile && selected && (
          ...
          >
            ...
            >
              ...
              <div style={{ display:'flex', gap:14, alignItems:'center', marginBottom:20 }}>
                ...
                <div>
                  ...
                  {selected.is_blacklisted && (
                    <span style={{ background:'#2d0a0a', border:'1px solid #7f1d1d', color:'#ef4444', borderRadius:6, padding:'2px 8px', fontSize:10, fontWeight:700 }}>
                      🚫 BLACKLISTED
                    </span>
                  )}
                </div>
              ...
              <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:8, marginBottom:16 }}>
                {[
                  ...
                  <div key={r.label} style={{
                    background:'#1f1d35', borderRadius:10, padding:'8px 12px',
                  }}>
              ...
              {/* Address */}
              <div style={{
                background:'#1f1d35', borderRadius:10, padding:'10px 12px', marginBottom:14,
              }}>
              ...
              <div style={{
                ...
                <div>
                  ...
                  <div style={{ fontSize:16, fontWeight:800, color:'#f1f0ff', letterSpacing:'0.08em' }}>
                  ...
                  <div style={{ display:'flex', flexDirection:'column', gap:6 }}>
                    {selected.slots.map(slot => (
                      <div key={slot.id} style={{
                        ...
                        <span style={{ fontSize:12, color:'#AFA9EC' }}>
                          {slot.groups?.name} · Slot #{slot.slot_number}
                        </span>
                        <span style={{
                          fontSize:11, fontWeight:700,
                          color: slot.status === 'paid' ? '#22c55e' : '#f59e0b',
                        }}>{slot.status}</span>
                      </div>
                    ))}
                  </div>
              ...
              {/* Blacklist / Remove blacklist button */}
              {!selected.is_blacklisted ? (
                <motion.button whileTap={{ scale:0.97 }}
                  ...
                  }}>🚫 Blacklist This Member</motion.button>
              ) : (
                <motion.button whileTap={{ scale:0.97 }}
                  ...
                  style={{
                    ...
                    color:'#22c55e', borderRadius:12,
                    fontSize:14, fontWeight:700, cursor:'pointer',
                  }}>↩ Remove from Blacklist</motion.button>
              )}
            </motion.div>
          </motion.div>
        )}
        ...
        {showBlacklist && selected && (
          ...
          >
            ...
            >
              ...
              <div style={{ fontSize:18, fontWeight:800, color:'#ef4444', textAlign:'center', marginBottom:8 }}>
                Blacklist {selected.full_name}?
              </div>
              ...
              <div style={{ display:'flex', gap:10 }}>
                ...
                <motion.button whileTap={{ scale:0.97 }}
                  onClick={blacklistMember} disabled={acting}
                  style={{
                    flex:1, padding:'12px',
                    background: acting ? '#2a2840' : 'linear-gradient(135deg, #ef4444, #dc2626)',
                    border:'none', color:'#fff',
